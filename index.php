...
<?php include('modal_add.php'); ?>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            <div class="alert alert-info">
                                ...
                                <strong><i class="icon-user icon-large"></i>&nbsp;List of Candidates this 38th Commencement Exercises!</strong>
                            </div>
                            <thead>
                                <tr>
                                    <th style="text-align:center;" ><font color="yellow">Image</font></th>
                                    <th style="text-align:center;" ><font color="yellow">First Name</font></th>
                                    <th style="text-align:center;" ><font color="yellow">Middle Name</font></th>
